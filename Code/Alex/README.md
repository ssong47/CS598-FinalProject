...
|160x120->80x60 + fcss data| 4 convolutional layers (f=[64(k=1x1),16,32,64. same], k=3x3,avgp:[1,2,2,2]), 2 sequential layers (flat + 128 Dense), Dropout at 128 Dense (0.2) + 2-layer neural network for fcss + 1 layer for concatenation| 50 val_loss mae | 2.51| 332 | 45 min | V5/test24 + V5/test30 + V5/test31 + V5/test32 + V5/test33 + V5/test35|
|160x120->80x60 + fcss data| 4 convolutional layers (f=[64(k=1x1),16,32,64. same], k=3x3,avgp:[1,2,2,2]), 2 sequential layers (flat + 128 Dense), Dropout at 128 Dense (0.2) + 2-layer neural network for fcss + 1 layer for concatenation + 1 layer post concat| 50 val_loss mae | **2.10**| 292 | 40 min | V5/test24 + V5/test30 + V5/test31 + V5/test32 + V5/test33 + V5/test35|
