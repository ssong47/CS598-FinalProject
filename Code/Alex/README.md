...
|160x120->80x60| 4 convolutional layers (f=[16,32,64,96. same], k=3x3,avgp:[2,2,2,2]), 2 sequential layers (flat + 128 Dense), Dropout at 128 Dense (0.2)| 50 val_loss mae | 3.29| 272 | 37 min | V5/test24 + V5/test30 + V5/test31 + V5/test32 + V5/test33 + V5/test35|
