...
|160x120->80x60 + fcss data. Saturate output| 4 convolutional layers (f=[16,32,64,96. same], k=3x3,avgp:[2,2,2,2]), 2 sequential layers (flat + 128 Dense), Dropout at 128 Dense (0.2) + 2-layer neural network for fcss + 1 layer for concatenation + 1 layer post concat| 50 val_loss mae | **1.97**| 281 | 38 min | V5/test24 + V5/test30 + V5/test31 + V5/test32 + V5/test33 + V5/test35|
