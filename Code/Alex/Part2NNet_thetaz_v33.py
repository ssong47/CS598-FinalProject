...
epochs = int(1200)
acc_best = 0
model.fit([X/255., X2], y, epochs=epochs, callbacks=[callback1, callback2], validation_data = ([Xvalid/255.,Xvalid2], y_valid),batch_size=batch_size, verbose=1)
model.save('cnn3v33')
...
if save_notebookparams:
    pkl_filename = "depthforcemodelparam_cnn3v33_pb.pkl"
    randata = {}
