...
def scheduler(epoch, lr):
    if epoch%300 < 200: #very hacky
        return 0.01
    else:
        if epoch%25==0 & batches==0:
            return lr * 0.99
        else:
            return lr
...
epochs = int(1130)
acc_best = 0
model.fit([X/255., X2], y, callbacks=[callback1, callback2], validation_data = ([Xvalid/255.,Xvalid2], y_valid),batch_size=batch_size, verbose=1)
model.save('cnn3v31')
