...
n_test = (30,31,32,33,35,47,49)
nw_resize = 2
nh_resize = 2
xtemp = {}
show_video = 0

subj = ['leo','leo','leo','leo','leo','leo','leo']
...
n_test = (30,31,32,33,35,47,49)
date = ('11_24_2020','11_24_2020','11_25_2020','11_25_2020','11_25_2020','12_15_2020','12_15_2020')
subj = ['leo','leo','leo','leo','leo','leo','leo']
subjwgt = [67, 67, 67, 67, 67, 67, 67]
subjht = [174, 174, 174, 174, 174, 174, 174]
xfcss_gt = {}
yrun = 0
for i in range(len(n_test)):
    test_str = 'test' + str(n_test[i])
